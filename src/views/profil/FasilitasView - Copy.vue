<template>
  <div class="min-h-screen bg-gray-50">
    ...
    >
      <div @click.stop class="bg-white rounded-xl max-w-4xl w-full my-8">
        <div class="p-8">
          <!-- Modal Header -->
          <div class="flex justify-between items-start mb-6">
            <h2 class="text-2xl font-bold text-gray-800">{{ selectedItem.nama_fasilitas }}</h2>
            <button
              @click="closeModal"
          ...
          <div class="mb-6 border-t pt-6">
            ...
            <p class="text-gray-700">{{ selectedItem.deskripsi || 'Tidak ada deskripsi' }}</p>
          </div>
